...
import { fetchAppeals, fetchFlags, fetchReports, fetchSanctions, patchAppeal, patchSanction } from "./api";
import { FLAG_STATUS_LABELS, REPORT_STATUS_LABELS, TYPE_LABELS } from "./constants";
import { toDraft } from "./helpers";
import { SidebarCard } from "./components";
import { usePreloadUserMetas } from "./userMeta";
import { AppealsSection } from "./sections/AppealsSection";
import { FlagsSection } from "./sections/FlagsSection";
import { ReportsSection } from "./sections/ReportsSection";
import { SanctionsSection } from "./sections/SanctionsSection";
import type { AppealDecision, AppealItem, FlaggedMessageItem, ModerationReportItem, SanctionDraft, SanctionItem, Tab } from "./types";

export function ModerationInner() {
