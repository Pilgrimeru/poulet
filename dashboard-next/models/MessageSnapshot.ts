...
MessageSnapshot.init(
  {
    ...
    authorUsername: { type: DataTypes.STRING, allowNull: false, defaultValue: "" },
    authorDisplayName: { type: DataTypes.STRING, allowNull: false, defaultValue: "" },
    authorAvatarURL: { type: DataTypes.STRING, allowNull: false, defaultValue: "" },
