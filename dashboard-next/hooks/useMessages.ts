...
export type MessageUpdateMode = "replace" | "append";
...
export function useMessages(guildID: string | null, channelID: string | null, filters: MessageFilters = DEFAULT_FILTERS) {
  ...
  const [updateMode, setUpdateMode] = useState<MessageUpdateMode>("replace");
  ...
  return { messages, loadMore, hasMore, loading, refresh, loadedChannelID, updateMode };
}
